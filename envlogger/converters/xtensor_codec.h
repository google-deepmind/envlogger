...
// floats. [Deprecated] This is no longer recommended as standard repeated
// fields are now faster in Python.
Datum Encode(const xt::xarray<float>& value, bool as_bytes = false);
