...
#ifndef THIRD_PARTY_PY_ENVLOGGER_PLATFORM_DEFAULT_STATUS_BUILDER_H_
#define THIRD_PARTY_PY_ENVLOGGER_PLATFORM_DEFAULT_STATUS_BUILDER_H_
...
#include "envlogger/platform/default/source_location.h"
...
class ABSL_MUST_USE_RESULT StatusBuilder {
 public:
  ...
  // occurs.
  StatusBuilder(const absl::Status& original_status, source_location location)
      : status_(original_status),
        line_(location.line()),
        file_(location.file_name()),
        stream_(new std::ostringstream) {}

  StatusBuilder(absl::Status&& original_status, source_location location)
  ...
  // will use `location` as the location from which the log message occurs.
...
inline StatusBuilder FailedPreconditionErrorBuilder(source_location location) {
...
inline StatusBuilder InvalidArgumentErrorBuilder(source_location location) {
...
#endif  // THIRD_PARTY_PY_ENVLOGGER_PLATFORM_DEFAULT_STATUS_BUILDER_H_
